...
public abstract class Registry<T> {
    ...
    private final ObservableList<T> itemsUnmodifiable
            = FXCollections.unmodifiableObservableList(items);

    /**
     * Registers an item with this registry. Items are kept track of by hard references, meaning that
     * any items registered will <i>not</i> be garbage collected until they are {@link #unregister
     * unregistered}.
     *
     * @param item the item to register
     * @throws IllegalArgumentException if the item has already been registered
     * @throws NullPointerException     if the item is null
     * @implSpec implementations <i>must</i> call the protected method {@link #addItem} at the end
     * of this method
     */
     ...
     * @implSpec implementations <i>must</i> call the protected method {@link #removeItem} at the
     * end of this method
     */
    public abstract void unregister(T item);

    /**
     * Adds an item to the list of registered items. This should <i>always</i> be called at the end of
     * {@link #register}.
     */
    ...
    /**
     * Removes an item from the list of registered items. This should <i>always</i> be called at the
     * end of {@link #unregister}.
     */
