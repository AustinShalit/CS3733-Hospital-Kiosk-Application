...
public final class ExceptionAlert extends Alert {
  private static final String PROJECT_ISSUE_LINK = "https://github"
      + ".com/AustinShalit/CS3733-D19-Team-O-Project/issues/new?body="
      + "Please%20describe%20what%20actions%20we%20can%20take%20to%20reproduce%20the%20bug%20you"
      + "%20found%2C%20including%20the%20error%20message.";

  private static final String ISSUE_PROMPT_TEXT = "An exception occurred!  Please open an issue "
   ...
   * @see <a href="https://github.com/WPIRoboticsProjects/GRIP/blob/master/ui/src/main/java/edu/wpi/grip/ui/ExceptionAlert.java">Inspiration</a>
   */
  public ExceptionAlert(final Parent root, final Throwable throwable, final String message,
    ...
    final ButtonType closeBtnType = new ButtonType("Close",
    ...
    this.setHeaderText("FATAL: " + message);
  ...
  private String generateExceptionMessage(Throwable throwable) {
    return new StringBuilder(Throwables.getStackTraceAsString(throwable)
        ...
        .replace(System.getProperty("user.name"), "$USER"))
  ...
  private String generateSystemInfoMessage() {
    ...
    systemInfo.append(Project.class.getPackage().getImplementationVersion())
        .append('\n');
