...
/**
 * A theme is a way of styling the application. Themes specify the location of CSS
 * stylesheets that modify the appearance of the UI.
 */
public class Theme {
	 ...
	 *
	 * <p><strong>Themes defined in plugins MUST NOT use this constructor.</strong> Themes defined in
	 * plugin jars will be unable to find their stylesheets, since those stylesheets are in a JAR
	 * somewhere that shuffleboard will not necessarily be aware of.
	 *
	...
	/**
	 * Creates a new theme with the given name and styled by the given style sheets. This is intended
	 * for use for themes defined in plugins.
	 *
	 * @param localClass  a class defined in the plugin.
	 * @param name        the name of the theme
	 * @param styleSheets the locations of the style sheets that the theme uses
	 */
