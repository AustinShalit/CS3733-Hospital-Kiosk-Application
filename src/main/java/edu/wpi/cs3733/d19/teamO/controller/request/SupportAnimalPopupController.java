...
public class SupportAnimalPopupController implements Controller {
  ...
  ImageView image1 = new ImageView(new Image(getClass().getResourceAsStream("../request/SupportAnimalSource/Jackson.jpg")));
  ImageView image2 = new ImageView(new Image(getClass().getResourceAsStream("../request/SupportAnimalSource/Chubbs.jpg")));
  ImageView image3 = new ImageView(new Image(getClass().getResourceAsStream("../request/SupportAnimalSource/Dora.jpg")));
  ImageView image4 = new ImageView(new Image(getClass().getResourceAsStream("../request/SupportAnimalSource/Marmalade.jpg")));
  ImageView image5 = new ImageView(new Image(getClass().getResourceAsStream("../request/SupportAnimalSource/Jasper.jpg")));
  ImageView image6 = new ImageView(new Image(getClass().getResourceAsStream("../request/SupportAnimalSource/Lois.jpg")));
  ImageView image7 = new ImageView(new Image(getClass().getResourceAsStream("../request/SupportAnimalSource/Lovey.jpg")));
  ImageView image8 = new ImageView(new Image(getClass().getResourceAsStream("../request/SupportAnimalSource/Mimi.jpg")));
  ImageView image9 = new ImageView(new Image(getClass().getResourceAsStream("../request/SupportAnimalSource/Oliver.jpg")));
  ...
  void initialize() {
    ...
    ArrayList<ImageView> imageViewList = new ArrayList<>(Arrays.asList(image1, image2, image3, image4,
