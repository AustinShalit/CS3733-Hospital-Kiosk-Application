...
public class ControllerHelper {
  ...
  private final static Set<String> states = new LinkedHashSet<>(Arrays.asList("AL", "AK",
      "AZ", "AR", "CA", "CO", "CT", "DE", "DC", "FL", "GA", "HI", "ID", "IL", "IN", "IA",
      "KS", "KY", "LA", "ME", "MD", "MA", "MI", "MN", "MS", "MO", "MT", "NE", "NV", "NH",
      "NJ", "NM", "NY", "NC", "ND", "OH", "OK", "OR", "PA", "RI", "SC", "SD", "TN", "TX",
      "UT", "VT", "VA", "WA", "WV", "WI", "WY"));

  private final static Set<Integer> years = new LinkedHashSet<>(Arrays.asList(2019, 2020, 2021,
      2022, 2023, 2024, 2025, 2026, 2027, 2028, 2029, 2030, 2031, 2032, 2033, 2034, 2035));

  private final static Set<Integer> months = new LinkedHashSet<>(Arrays.asList(1, 2, 2,
