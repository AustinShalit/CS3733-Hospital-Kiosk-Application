...
public abstract class Registry<T> {
   ...
   * any items registered will <i>not</i> be garbage collected until they
   * are {@link #unregister unregistered}.
   *
   * @param item the item to register
   *
   * @throws IllegalArgumentException if the item has already been registered
   * @throws NullPointerException     if the item is null
   * @implSpec implementations <i>must</i> call the protected method {@link #addItem} at the end of
   *    this method
   */
